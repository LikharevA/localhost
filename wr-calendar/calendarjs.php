...
if ($shapka=="1") {echo "document.write(\"<html><head><style>TD {COLOR:#333333; FONT-FAMILY:Verdana,Arial; FONT-SIZE:11px; LINE-HEIGHT:150%; padding-left:0; BORDER-RIGHT:#666666 1px solid; BORDER-TOP:#666666 0px solid; BORDER-LEFT:#666666 0px solid; BORDER-BOTTOM:#666666 1px solid;} .sun{COLOR:#ffffff; FONT-WEIGHT: bold; Background:#ff9900;} .seg{COLOR:#ffffff; FONT-WEIGHT: bold; Background:$hcolor;}</style></head><body>\");";}
echo "document.write(\"<table align=center border=1 cellpadding=2 cellspacing=0 bordercolor=$bcolor><caption><font face='Verdana' size=-1><B>".$months[date('n')-1]."</caption></B></font><TR align=middle valign=middle>\");";
do {
...
echo "document.write(\"<td $addse $add width=23>$addbb $rdt[$ii]</td>\");";
    } while ($i<$vmax);

 if ($ii<"6") {echo "document.write(\"</tr><TR align=middle valign=middle>\");";}
 $i="0"; $ii++;
 } while ($ii<"7");
